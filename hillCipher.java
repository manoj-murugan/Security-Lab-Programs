...
public static int[][] invkeymat = new int[][] { { -1, 0, 1 }, { 2, -1, 0 }, { -2, 2, -1} }; public static String key = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
a = key.charAt(x % 26); b = key.charAt(y % 26); c = key.charAt(z % 26); ret = "" + a + b + c; return ret;
}
